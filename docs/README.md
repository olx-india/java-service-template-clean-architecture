...
|----------|-------------|
| [Local setup](local-setup.md) | Prerequisites, environment, and running the service locally |
| [Features](features.md) | Capabilities included in this template |
| [Clean architecture](clean-architecture.md) | Layer model, dependency rules, and request lifecycle |
